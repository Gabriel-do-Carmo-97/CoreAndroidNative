...
- [`CameraPreview`](src/main/java/br/com/wgc/core/camera/CameraPreview.kt):
...
- [`QrCodeScannerAnalyzer`](src/main/java/br/com/wgc/core/camera/QrCodeScannerAnalyzer.kt):
