...
- [`LocationClient`](src/main/java/br/com/wgc/core/location/LocationClient.kt):
...
- [`DistanceUtils`](src/main/java/br/com/wgc/core/location/DistanceUtils.kt):
...
```kotlin
dependencies {
    implementation("br.com.wgc:core-location:1.2.0")
}
```
