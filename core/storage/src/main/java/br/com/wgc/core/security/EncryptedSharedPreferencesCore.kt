...
class EncryptedSharedPreferencesCore @Inject constructor(
    ...
    override fun saveString(key: String, value: String) = sharedPreferences.edit {
        putString(key, value)
    }
    ...
    override fun saveInt(key: String, value: Int) = sharedPreferences.edit {
        putInt(key, value)
    }
    ...
    override fun saveBoolean(key: String, value: Boolean) = sharedPreferences.edit {
    ...
    override fun saveFloat(key: String, value: Float) = sharedPreferences.edit {
        putFloat(key, value)
    }
    ...
    override fun saveLong(key: String, value: Long) = sharedPreferences.edit {
        putLong(key, value)
    }
    ...
    override fun saveStringSet(key: String, value: Set<String>) = sharedPreferences.edit {
    ...
    override fun remove(key: String) = sharedPreferences.edit {
        remove(key)
    }
